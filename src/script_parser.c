...
#define ELEMENT_MUST_BE_ADDRESS(pE, i) {                                                                              \
    _Static_assert(sizeof(NONFUNGIBLETOKEN_METADATAVIEWS_TESTNET) == ADDRESS_STRING_LENGTH + 1, "Incompatible types"); \
    _Static_assert(sizeof(NONFUNGIBLETOKEN_METADATAVIEWS_MAINNET) == ADDRESS_STRING_LENGTH + 1, "Incompatible types"); \
